...
return(
  <div className="detail_container">
    ...
    <div className="tab">
      <button className={button === "객실안내/예약" ? "active" : ""} onClick={() => ButtonClick("객실안내/예약")}>객실안내/예약</button>
      <button className={button === "숙소정보" ? "active" : ""} onClick={() => ButtonClick("숙소정보")}>숙소정보</button>
      <button className={button === "리뷰" ? "active" : ""} onClick={() => ButtonClick("리뷰")}>리뷰</button>
    </div>

    <div className="room/booking">
      {button === "객실안내/예약" && (
        <div className={"start " + end}>
          <RoomReservation button={button} setButton={setButton}></RoomReservation>
        </div>
      )}
    </div>
    <div className="roominfo">
      {button === "숙소정보" && (
        <div className={"start " + end}>
          <RoomInformation button={button} setButton={setButton}></RoomInformation>
        </div>
      )}
    </div>
